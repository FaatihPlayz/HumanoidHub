...
local roundcornerscript1 = Instance.new("UICorner")
local label = Instance.new("TextLabel")
local roundcornerscript2 = Instance.new("UICorner")
...
mainframe.Position = UDim2.new(0.0572851822, 0, 0.0472727269, 0)
mainframe.Size = UDim2.new(0, 595, 0, 256)
mainframe.Active = true

roundcornerscript1.Name = "roundcornerscript1"
roundcornerscript1.Parent = mainframe

label.Name = "label"
label.Parent = mainframe
label.BackgroundColor3 = Color3.fromRGB(42, 42, 42)
label.BorderSizePixel = 0
label.Size = UDim2.new(0, 109, 0, 22)
label.Font = Enum.Font.SourceSans
label.Text = "Humanoid Hub"
label.TextColor3 = Color3.fromRGB(255, 255, 255)
label.TextSize = 14.000

roundcornerscript2.Name = "roundcornerscript2"
roundcornerscript2.Parent = label

button1.Name = "button1"
button1.Parent = mainframe
button1.BackgroundColor3 = Color3.fromRGB(83, 83, 83)
button1.Position = UDim2.new(0.0184873957, 0, 0.0859375, 0)
button1.Size = UDim2.new(0, 124, 0, 29)
...
button1_2.Parent = mainframe
button1_2.BackgroundColor3 = Color3.fromRGB(83, 83, 83)
button1_2.Position = UDim2.new(0.275630265, 0, 0.0859375, 0)
button1_2.Size = UDim2.new(0, 124, 0, 29)
button1_2.Font = Enum.Font.SourceSans
button1_2.Text = "Noclip (Press e to toggle)"
button1_2.TextColor3 = Color3.fromRGB(0, 0, 0)
button1_2.TextSize = 14.000
button1_2.MouseButton1Down:connect(function()
...
button1_3.Parent = mainframe
button1_3.BackgroundColor3 = Color3.fromRGB(83, 83, 83)
button1_3.Position = UDim2.new(0.541176498, 0, 0.0859375, 0)
button1_3.Size = UDim2.new(0, 124, 0, 29)
button1_3.Font = Enum.Font.SourceSans
button1_3.Text = "InfJump"
button1_3.TextColor3 = Color3.fromRGB(0, 0, 0)
button1_3.TextSize = 14.000
button1_3.MouseButton1Down:connect(function()
